...
all_models = [ "DeepFM", "DANet", "NODE", "DNFNet", "CatBoost"] # , "LinearModel", "KNN", "DecisionTree", "RandomForest", "XGBoost", "LightGBM", "ModelTree",
               # "MLP", "TabNet", "VIME", "TabTransformer","DeepGBM", "RLN", "STG", "NAM",
#                "SAINT",
